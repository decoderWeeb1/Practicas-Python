...
#Ejercicio 2
C1=int(input("Ingrese el valor de la calificacion 1: "))
C2=int(input("Ingrese el valor de la calificacion 2: "))
C3=int(input("Ingrese el valor de la calificacion 3: "))
